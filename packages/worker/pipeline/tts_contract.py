...
TTS_TRITON_INPUT_SPECS = (
    f"{TTS_TEXT_INPUT}: BYTES[1] UTF-8 text to synthesize",
    f"{TTS_LANGUAGE_INPUT}: BYTES[1] required target language code",
    f"{TTS_SPEAKER_PROMPT_INPUT}: BYTES[1] optional prompt for speaking style; empty string means default voice",
)
